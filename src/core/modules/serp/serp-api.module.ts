...
import { SerpGoogleAdsSearchLocationsListTool } from './tools/serp-google-ads-search-locations-list.tool.js';
import { SerpGoogleAdsAdvertisersLiveAdvancedTool } from './tools/serp-google-ads-advertisers-live-advanced.tool.js';
import { SerpGoogleAdsAdvertisersLocationsListTool } from './tools/serp-google-ads-advertisers-locations-list.tool.js';
...
export class SerpApiModule extends BaseModule {
  getTools(): Record<string, ToolDefinition> {
    const tools = [
      ...
      new SerpGoogleAdsSearchLocationsListTool(this.dataForSEOClient),
      new SerpGoogleAdsAdvertisersLiveAdvancedTool(this.dataForSEOClient),
      new SerpGoogleAdsAdvertisersLocationsListTool(this.dataForSEOClient),
