...
export class SerpGoogleAdsSearchLocationsListTool extends BaseTool {
  constructor(dataForSEOClient: DataForSEOClient) {
    super(dataForSEOClient);
  }

  getName(): string {
    return 'serp_google_ads_search_locations_list';
  }

  getDescription(): string {
    return 'Get the list of supported locations for Google Ads Search. This endpoint returns available locations that can be used with the Google Ads Search API.';
  }
