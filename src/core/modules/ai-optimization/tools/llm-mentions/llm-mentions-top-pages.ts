...
export class LlmMentionsTopPagesTool extends BaseTool {
  ...
  getDescription(): string {
    return 'Get top mentioned pages for a keyword or domain. Returns aggregated mentions metrics grouped by the most frequently mentioned pages, helping identify which specific pages get cited in LLM responses.';
  }
