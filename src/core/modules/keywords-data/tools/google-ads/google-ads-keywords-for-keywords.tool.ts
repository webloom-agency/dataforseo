...
export class GoogleAdsKeywordsForKeywordsTool extends BaseTool {
  ...
  getDescription(): string {
    return 'Get keyword suggestions based on seed keywords. Returns related keyword ideas, search volume, competition, and CPC data. Perfect for expanding keyword lists and discovering new keyword opportunities for PPC campaigns.';
  }

  getParams(): z.ZodRawShape {
    return {
      keywords: z.array(z.string()).describe('Seed keywords to get suggestions for (max 10)'),
